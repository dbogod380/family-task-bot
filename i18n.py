...
STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "tz_choose": "🌍 How would you like to set your timezone?",
        "tz_opt_auto": "📍 Auto-detect from location",
        "tz_opt_manual": "✏️ Enter manually",
        "tz_manual_instructions": "Send your timezone name, for example:\n`/timezone Europe/London`\n`/timezone America/New_York`\n`/timezone Asia/Tokyo`",
    ...
    "ru": {
        ...
        "tz_choose": "🌍 Как вы хотите установить часовой пояс?",
        "tz_opt_auto": "📍 Определить по геолокации",
        "tz_opt_manual": "✏️ Ввести вручную",
        "tz_manual_instructions": "Отправьте название часового пояса, например:\n`/timezone Europe/Moscow`\n`/timezone Europe/London`",
